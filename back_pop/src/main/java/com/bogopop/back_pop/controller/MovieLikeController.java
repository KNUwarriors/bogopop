...
public class MovieLikeController {
    ...
    @Autowired
    public MovieLikeController(LikeService likeService, UserService userService) {
        this.likeService = likeService;
        this.userService = userService;
    }


    @GetMapping("/movies/addLike")
    @ResponseBody
    public ResponseEntity<Object> addLike(@RequestParam Long movieId, Authentication authentication) {
    ...
    @GetMapping("/movies/deleteLike")
    @ResponseBody
    public ResponseEntity<Object> deleteLike(@RequestParam Long movieId, Authentication authentication) {
